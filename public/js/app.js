...
function initAdmin() {
  ...
  function generateMarkup(orders) {
    //here we are fetching the data of customers who placed order and displaying in table of admin i.e adim/order.ejs
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    var pizza = JSON.parse(btn.dataset.pizza); //this will return object
